...
var useCurrentUser_1 = __importDefault(require("./useCurrentUser"));
var useLoginModal_1 = __importDefault(require("./useLoginModal"));
var usePost_1 = __importDefault(require("./usePost"));
var client_1 = require("../api/client");
var react_query_1 = require("@tanstack/react-query");
var useLike = function (_a) {
  var postId = _a.postId,
    userId = _a.userId;
  var currentUser = (0, useCurrentUser_1.default)().data;
  var _b = (0, usePost_1.default)(postId),
    fetchedPost = _b.data,
    mutateFetchedPost = _b.mutate;
  var client = (0, client_1.useClient)();
  var queryClient = (0, react_query_1.useQueryClient)();
  var loginModal = (0, useLoginModal_1.default)();
  var hasLiked = (0, react_1.useMemo)(
    function () {
      var list =
        (fetchedPost === null || fetchedPost === void 0
          ? void 0
  ...
  var toggleLike = (0, react_1.useCallback)(
    function () {
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            ...
            case 1:
              ...
              if (hasLiked) {
                request = function () {
                  return axios_1.default.delete("/api/like", {
                    params: { postId: postId },
                  });
                };
              } else {
                request = function () {
                  return axios_1.default.post("/api/like", { postId: postId });
                };
              }
