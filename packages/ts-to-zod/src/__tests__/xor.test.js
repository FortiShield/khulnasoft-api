    ...
    return __generator(this, function (_b) {
      switch (_b.label) {
        ...
        case 1:
          ...
          T = zod_1.default.union([
            zod_1.default.object({ language: zod_1.default.undefined() }).and(
              zod_1.default.lazy(function () {
                return Pet;
              })
            ),
            zod_1.default.object({ breed: zod_1.default.undefined() }).and(
              zod_1.default.lazy(function () {
                return Person;
              })
            ),
          ...
          expect(function () {
            return T.parse({ name: "Dogman", language: "woof", breed: "?" });
          }).toThrow();
          return [2 /*return*/];
      }
    });
